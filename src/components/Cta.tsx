    ...
    <section className="py-24 bg-verde-escuro text-branco relative overflow-hidden" ref={ctaRef}>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center fadeIn">
          <span className="inline-block px-6 py-2 rounded-full bg-verde-claro/20 text-verde-claro text-sm font-semibold uppercase tracking-wide mb-6">
            Elite Experience
          </span>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            <Button className="premium-btn bg-gradient-to-r from-verde-claro to-verde-claro/80 hover:from-verde-claro hover:to-verde-claro text-verde-escuro text-lg py-7 px-10 font-bold rounded-xl hover:shadow-[0_8px_30px_rgba(163,201,168,0.6)] transition-all duration-300 transform hover:scale-105">
